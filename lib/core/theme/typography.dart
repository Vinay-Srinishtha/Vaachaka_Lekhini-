...
abstract final class KvlText {
  ...
  static TextStyle body([double size = 13]) => GoogleFonts.lexend(
    fontSize: size,
  ...
  static TextStyle caption([double size = 11]) => GoogleFonts.lexend(
    fontSize: size,
    fontWeight: FontWeight.w400,
  ...
  static TextStyle muted([double size = 10.5]) => GoogleFonts.lexend(
    fontSize: size,
    fontWeight: FontWeight.w400,
  ...
  static TextStyle mantraKannada([double size = 24]) => GoogleFonts.tiroKannada(
    fontSize: size,
    fontWeight: FontWeight.w400,
    color: KvlColors.ink,
    height: 1.4,
  ...
  static TextStyle mantraByScript(MantraScript script, [double size = 26]) =>
      switch (script) {
        MantraScript.latin => GoogleFonts.lexend(
          fontSize: size,
          fontWeight: FontWeight.w400,
          color: KvlColors.ink,
          height: 1.25,
        ),
        MantraScript.devanagari => mantraDevanagari(size),
        MantraScript.telugu => mantraTelugu(size),
        MantraScript.kannada => mantraKannada(size),
      };

  static TextStyle bodyByScript(MantraScript script, [double size = 13]) =>
      switch (script) {
        MantraScript.latin => body(size),
        MantraScript.devanagari => bodyDevanagari(size),
        MantraScript.telugu => bodyTelugu(size),
        MantraScript.kannada => bodyKannada(size),
      };

  /// Big number readout (Indian-style comma grouping; pair with [IndianNumberFormat]).
  static TextStyle bigNumber([double size = 26]) => GoogleFonts.lexend(
    fontSize: size,
...
class MantraText extends StatelessWidget {
  const MantraText(
    this.text, {
    super.key,
    this.script = MantraScript.devanagari,
    this.size = 26,
    this.color,
  });
  ...
  Widget build(BuildContext context) {
    final style = switch (script) {
      MantraScript.latin => KvlText.mantraByScript(MantraScript.latin, size),
...
enum MantraScript { latin, devanagari, telugu, kannada }
