...
class MantraRow extends StatelessWidget {
  const MantraRow({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: KvlCard(
        ...
        child: Row(
          children: [
            MantraThumb(glyph: mantra.name.thumbGlyph(), palette: mantra.thumbPalette),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(mantra.name.roman, style: KvlText.ui(13, FontWeight.w600)),
