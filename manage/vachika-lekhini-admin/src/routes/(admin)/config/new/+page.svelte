...
<Modal open title="New flag" size="lg" formId="flag-form" saveLabel="Create flag" onClose={close}>
	<FeatureFlagForm {value} fieldErrors={form?.fieldErrors ?? {}} submitLabel="Create flag" onSuccess={handleSuccess} inModal />
</Modal>
