...
<svelte:head><title>Feedback · {data.report.subject}</title></svelte:head>

<div class="max-w-2xl space-y-6">

	<!-- Back -->
	<a href="/feedback" class="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-800 transition-colors">
