...
<Modal open title="New Global Sadhana" subtitle="Create a community spiritual initiative" size="lg" onClose={close}>
	...
	<form method="POST" class="space-y-5">
		...
		<!-- Media & Settings -->
		<section class="card p-5 space-y-4">
			<p class="section-label">Media & Settings</p>
			<div>
				<label class="block text-sm font-medium text-slate-700 mb-1.5" for="image_url">Banner Image URL</label>
				<input id="image_url" name="image_url" type="url" value={v.image_url ?? ''} class="input" placeholder="https://…" />
			</div>
